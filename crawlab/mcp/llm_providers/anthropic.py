...
class AnthropicProvider(BaseLLMProvider):
    ...
    def __init__(
        ...
        self.model_name = model_name or os.getenv(f"{self.provider_name}_MODEL_NAME", "claude-3-sonnet-20240229")
    ...
    def _convert_to_anthropic_messages(self, messages: List[Dict[str, str]]) -> List[Dict[str, Any]]:
